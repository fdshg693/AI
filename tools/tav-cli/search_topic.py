...
PowerShell example:
    python .\tools\tav-cli\search_topic.py "Microsoft Fabric overview" --topic fabric_overview

bash example:
    python ./tools/tav-cli/search_topic.py "Microsoft Fabric overview" --topic fabric_overview
"""
