...
PowerShell example:
    python .\tools\tav-cli\crawl_site_content.py https://learn.microsoft.com/azure/api-management/ --query "workspace feature limitations" --topic apim_workspace

bash example:
    python ./tools/tav-cli/crawl_site_content.py https://learn.microsoft.com/azure/api-management/ --query "workspace feature limitations" --topic apim_workspace
"""
