...
# The audit log directory, ``logs/`` (this module lives in ``tav_core/``, a sibling of the repo-root ``tools/tav-cli/``).
...
def emit(
    channel: OutputChannel, payload: Any, *, path: Path | None = None, pretty: bool = True
) -> None:
