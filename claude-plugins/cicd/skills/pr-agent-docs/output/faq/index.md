...
??? note "Q: Can PR-Agent serve as a substitute for a human reviewer?" #### Answer:<span style="display:none;">1</span>
...
??? note "Q: How can I get more tailored suggestions?" #### Answer:<span style="display:none;">3</span>
...
??? note "Q: Will you store my code? Are you using my code to train models?" #### Answer:<span style="display:none;">4</span>
...
??? note "Q: Can PR-Agent review draft/offline PRs?" #### Answer:<span style="display:none;">6</span>
...
??? note "Q: Can the 'Review effort' feedback be calibrated or customized?" #### Answer:<span style="display:none;">7</span>
...
??? note "Q: How to reduce the noise generated by PR-Agent?" #### Answer:<span style="display:none;">3</span>
